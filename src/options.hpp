...
OPTION( walkpassat,        0,  0, 29,1,0,1, "PASSAT: 0=off; 1-7 exact break (s=10, s=100, s=unlim, s=1pct, s=10pct, s=50pct, up_expansion), 8-14 cheap break, 15 dynamic barrier 1pct<->10pct + improvement-tracking, 16 s=0.1pct + improvement-tracking, 17 v5+improv, 18 v5+3x tick limit, 19 v15+3xtl, 20 v16+3xtl, 21 v17+3xtl, 22 v5+anti-stagnation, 23 v22+3xtl, 24 v5+autarky, 25 v7+autarky, 26 v25+3xtl, 27 v19+autarky, 28 v7+ autarky-check only after expansion, 29 v7 autarky-check only after repair") \
