...
OPTION( walkpassat,        0,  0, 21,1,0,1, "PASSAT: 0=off; 1-7 exact break (s=10, s=100, s=unlim, s=1pct, s=10pct, s=50pct, up_expansion), 8-14 cheap break, 15 dynamic barrier 1pct<->10pct + improvement-tracking, 16 s=0.1pct + improvement-tracking, 17 v5+improv, 18 v5+7x tick limit, 19 v15+7xtl, 20 v16+7xtl, 21 v17+7xtl") \
