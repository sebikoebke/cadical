...
OPTION( walkpassat,        0,  0, 43,1,0,1, "PASSAT: 0=off; 1-7 exact break (s=10, s=100, s=unlim, s=1pct, s=10pct, s=50pct, up_expansion), 8-14 cheap break, 15 dynamic barrier 1pct<->10pct + improvement-tracking, 16 s=0.1pct + improvement-tracking, 17 v5+improv, 18 v5+3x tick limit, 19 v15+3xtl, 20 v16+3xtl, 21 v17+3xtl, 22 v5+anti-stagnation, 23 v22+3xtl, 24 v5+autarky, 25 v7+autarky, 26 v25+3xtl, 27 v19 + autarky-check after repair + elimination, 28 v5 + autarky-check after repair + elimination, 29 v7 + autarky-check after repair + elimination, 30 v22 + autarky-check only after expansion + elimination, 31 v22 + autarky-check only after repair + elimination, 32 v22 + autarky-check after expansion and after repair + elimination, 33 v31 + repair-pick scored by base^lsl, 34 v31 + repair-pick scored by broken_occ, 35 v31 + repair-pick scored by broken_occ*base^bv, 36 v31 + advanced multi-clause picking, 37 v27 + advanced multi-clause picking, 38 v37 + duplicate and drop filter, 39 v31 + finding new pure lits, 40 v29 + finding new pure lits, 41 v31 + autarky check at TUC Minima, 42 v39 + 3x tick limit, 43 v40 + 3x tick limit") \
